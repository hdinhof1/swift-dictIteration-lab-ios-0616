...
var variable = ["Nirvana": "Nevermind",
 ...
 */
// write your code here
for (bandName, album) in variable {
    print ("\(bandName)'s top-selling album was \(album)")
}
 ...
 */
// write your code here
for (grade, score) in yearWithGradeAverage {
